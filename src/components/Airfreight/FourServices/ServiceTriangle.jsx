...
export default function ServiceTriangle({ initialColor = '#E1261D', hoverColor, textToShow, content, height, width, changeContent, defaultContent, top = false, id }) {
  ...
  const onTextClickHandle = () => {
    ...
    if (targetElement) {
      console.log("element fetched", targetElement, id);
